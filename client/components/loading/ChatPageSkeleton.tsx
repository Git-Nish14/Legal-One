const ChatPageSkeleton: React.FC = () => {
    return (
        <div className="flex flex-col h-screen p-4 md:p-10 animate-pulse">
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-10 flex-grow">
                ...
                <div className="flex flex-col w-full md:w-1/2 space-y-6">
                    ...
                    <div className="flex flex-col items-center text-center">
                        <div className="w-32 h-32 md:w-40 md:h-40 bg-gray-300 rounded-full border border-gray-300 shadow-lg"></div>
