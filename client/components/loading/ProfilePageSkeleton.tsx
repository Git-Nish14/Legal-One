const ProfilePageSkeleton: React.FC = () => {
    return (
        <div className="min-h-screen flex flex-col md:flex-row bg-gray-100 ml-0 md:ml-10 relative animate-pulse">
            {/* Back Button Skeleton */}
            <div className="absolute top-4 right-4 md:top-6 md:right-10 flex items-center gap-2 bg-gray-300 px-4 py-2 rounded-md shadow">
                <div className="w-5 h-5 bg-gray-400 rounded-full"></div>
                <div className="w-16 h-5 bg-gray-400 rounded"></div>
            </div>

            {/* Left Section - Image Placeholder */}
            <div className="w-full md:w-1/3 bg-gray-300 flex justify-center items-center p-6 md:p-10 rounded-2xl">
            ...
            <div className="w-full md:w-2/3 p-6 md:p-16 bg-white shadow-md flex flex-col justify-center">
                {/* Name Placeholder */}
                ...
                <div className="mt-10 w-1/2 md:w-1/3 h-12 bg-gray-400 rounded-md"></div>
            </div>
        </div>
    );
};
